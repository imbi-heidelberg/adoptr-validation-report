...
## 3 two-stage        <TwStgDsg> <adptrOpR [3]>  17.0    17.0  16.6     16.6
\end{verbatim}
...
\NormalTok{H_}\DecValTok{0}\NormalTok{        <-}\StringTok{ }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\NormalTok{prior      <-}\StringTok{ }\KeywordTok{ContinuousPrior}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(delta) }\KeywordTok{dnorm}\NormalTok{(delta, }\DataTypeTok{mean =} \FloatTok{.4}\NormalTok{, }\DataTypeTok{sd =} \FloatTok{.2}\NormalTok{),}
                              \DataTypeTok{support =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{5}\NormalTok{),}
                              \DataTypeTok{tighten_support =} \OtherTok{TRUE}\NormalTok{,}\DataTypeTok{check_normalization =} \OtherTok{FALSE}\NormalTok{)}
...
\hypertarget{objective-21}{%
\subsection{Objective}\label{objective-21}}
...
\hypertarget{constraints-21}{%
\subsection{Constraints}\label{constraints-21}}

No additional constraints are considered in this variant.

\hypertarget{initial-design-16}{%
\subsection{Initial Design}\label{initial-design-16}}
