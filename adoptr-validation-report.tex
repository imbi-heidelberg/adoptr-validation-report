...
\hypersetup{
  ...
  pdfauthor={Kevin Kunzmann, Maximilian Pilz \& Nico Bruder},
  hidelinks,
...
\begin{Highlighting}[]
\NormalTok{tbl_performance <-}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}
    \DataTypeTok{delta =} \KeywordTok{c}\NormalTok{(.}\DecValTok{0}\NormalTok{, }\FloatTok{.2}\NormalTok{) ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
        \DataTypeTok{power     =} \KeywordTok{map}\NormalTok{(}
\NormalTok{            delta, }
            \OperatorTok{~}\KeywordTok{evaluate}\NormalTok{(}
...
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_gte}\NormalTok{(}
\NormalTok{    tbl_performance }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(delta }\OperatorTok{==}\StringTok{ }\FloatTok{0.2}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{pull}\NormalTok{(power_sim),}
\NormalTok{    min_power }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{tol) )}
...
\begin{Highlighting}[]
\NormalTok{cp       <-}\StringTok{ }\KeywordTok{ConditionalPower}\NormalTok{(datadist, prior)}
\NormalTok{cp_cnstr <-}\StringTok{ }\NormalTok{cp }\OperatorTok{>=}\StringTok{ }\FloatTok{.85}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{tibble}\NormalTok{(}
    ...
    \DataTypeTok{cp     =} \KeywordTok{map_dbl}\NormalTok{(x1, }\OperatorTok{~}\KeywordTok{evaluate}\NormalTok{(cp, opt_cp}\OperatorTok{$}\NormalTok{design, .)),}
    \DataTypeTok{cp_sim =} \KeywordTok{map_dbl}\NormalTok{(x1, }\ControlFlowTok{function}\NormalTok{(x1) \{}
\NormalTok{        x2  <-}\StringTok{ }\KeywordTok{simulate}\NormalTok{(datadist, }\DecValTok{10}\OperatorTok{^}\DecValTok{6}\NormalTok{, }\KeywordTok{n2}\NormalTok{(opt_cp}\OperatorTok{$}\NormalTok{design, x1), }\FloatTok{.2}\NormalTok{, }\DecValTok{42}\NormalTok{)}
\NormalTok{        rej <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(x2 }\OperatorTok{>}\StringTok{ }\KeywordTok{c2}\NormalTok{(opt_cp}\OperatorTok{$}\NormalTok{design, x1), }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
        \KeywordTok{return}\NormalTok{(}\KeywordTok{mean}\NormalTok{(rej))}
\NormalTok{    \}) ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{%>%}\StringTok{ }\NormalTok{\{}
\NormalTok{      testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{cp     }\OperatorTok{>=}\StringTok{ }\FloatTok{0.85} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{tol)))}
\NormalTok{      testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{cp_sim }\OperatorTok{>=}\StringTok{ }\FloatTok{0.85} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{tol))) }
\NormalTok{      testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(}\KeywordTok{abs}\NormalTok{(.}\OperatorTok{$}\NormalTok{cp }\OperatorTok{-}\StringTok{ }\NormalTok{.}\OperatorTok{$}\NormalTok{cp_sim) }\OperatorTok{<=}\StringTok{ }\NormalTok{tol)) \}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{datadist   <-}\StringTok{ }\KeywordTok{Binomial}\NormalTok{(}\DataTypeTok{rate_control=}\FloatTok{0.3}\NormalTok{, }\DataTypeTok{two_armed =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{H_}\DecValTok{0}\NormalTok{        <-}\StringTok{ }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\NormalTok{prior      <-}\StringTok{ }\KeywordTok{ContinuousPrior}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(x) }\DecValTok{1}\OperatorTok{/}\NormalTok{(}\KeywordTok{pnorm}\NormalTok{(}\FloatTok{0.69}\NormalTok{,}\FloatTok{0.2}\NormalTok{,}\FloatTok{0.2}\NormalTok{)}\OperatorTok{-}\KeywordTok{pnorm}\NormalTok{(}\OperatorTok{-}\FloatTok{0.29}\NormalTok{,}\FloatTok{0.2}\NormalTok{,}\FloatTok{0.2}\NormalTok{))}\OperatorTok{*}\KeywordTok{dnorm}\NormalTok{(x,}\FloatTok{0.2}\NormalTok{,}\FloatTok{0.2}\NormalTok{),}
                              \DataTypeTok{support =} \KeywordTok{c}\NormalTok{(}\OperatorTok{-}\FloatTok{0.29}\NormalTok{,}\FloatTok{0.69}\NormalTok{),}
                              \DataTypeTok{tighten_support =} \OtherTok{TRUE}\NormalTok{)}
...
\NormalTok{min_epower <-}\StringTok{ }\FloatTok{0.8}
\NormalTok{toer_cnstr <-}\StringTok{ }\KeywordTok{Power}\NormalTok{(datadist, H_}\DecValTok{0}\NormalTok{) }\OperatorTok{<=}\StringTok{ }\NormalTok{alpha}
\NormalTok{epow_cnstr <-}\StringTok{ }\KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{condition}\NormalTok{(prior, }\KeywordTok{c}\NormalTok{(}\FloatTok{0.0}\NormalTok{,}\FloatTok{0.69}\NormalTok{))) }\OperatorTok{>=}\StringTok{ }\NormalTok{min_epower}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ess_}\DecValTok{0}\NormalTok{ <-}\StringTok{ }\KeywordTok{ExpectedSampleSize}\NormalTok{(datadist, }\KeywordTok{condition}\NormalTok{(prior, }\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\FloatTok{0.29}\NormalTok{,}\DecValTok{0}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cp       <-}\StringTok{ }\KeywordTok{ConditionalPower}\NormalTok{(datadist, }\KeywordTok{condition}\NormalTok{(prior, }\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.69}\NormalTok{)))}
\NormalTok{cp_cnstr <-}\StringTok{ }\NormalTok{cp }\OperatorTok{>=}\StringTok{ }\FloatTok{0.7}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{test-cases-19}{%
\subsection{Test Cases}\label{test-cases-19}}
...
The type one error rate is tested via simulation and compared to the value obtained by \texttt{evaluate()}.
...
\NormalTok{datadist <-}\StringTok{ }\KeywordTok{Student}\NormalTok{(}\DataTypeTok{two_armed=}\OtherTok{TRUE}\NormalTok{)}
\NormalTok{H_}\DecValTok{0}\NormalTok{ <-}\StringTok{ }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{)}
\NormalTok{prior <-}\StringTok{ }\KeywordTok{PointMassPrior}\NormalTok{(}\FloatTok{1.0}\NormalTok{,}\DecValTok{1}\NormalTok{)}
...
\NormalTok{tbl_designs <-}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}
    \DataTypeTok{type    =} \KeywordTok{c}\NormalTok{(}\StringTok{"one-stage"}\NormalTok{, }\StringTok{"group-sequential"}\NormalTok{, }\StringTok{"two-stage"}\NormalTok{),}
    \DataTypeTok{initial =} \KeywordTok{list}\NormalTok{(}
        \KeywordTok{OneStageDesign}\NormalTok{(}\DecValTok{20}\NormalTok{, }\FloatTok{2.0}\NormalTok{),}
        \KeywordTok{rpact_design}\NormalTok{(datadist, }\FloatTok{1.0}\NormalTok{, }\FloatTok{0.025}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\OtherTok{TRUE}\NormalTok{, order),}
        \KeywordTok{TwoStageDesign}\NormalTok{(}\KeywordTok{rpact_design}\NormalTok{(datadist, }\FloatTok{1.0}\NormalTok{, }\FloatTok{0.025}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\OtherTok{TRUE}\NormalTok{, order))) )}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{      type, }
      \DataTypeTok{toer  =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl_designs}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{~}\KeywordTok{sim_pr_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob), }
      \DataTypeTok{power =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl_designs}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{~}\KeywordTok{sim_pr_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{1.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob) ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(toer, power)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{%>%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer  }\OperatorTok{<=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{power }\OperatorTok{>=}\StringTok{ }\NormalTok{min_power }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{tol))) }
...
\(n_2\) function) and this is more flexible than the optimal one-stage design (no second stage), the expected sample sizes under the prior should be ordered in the opposite way. Additionally, expected sample sizes under the null hypothesis are computed both via \texttt{evaluate()} and simulation-based.
...
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
        \DataTypeTok{ess      =} \KeywordTok{map_dbl}\NormalTok{(optimal,}
                           \OperatorTok{~}\KeywordTok{evaluate}\NormalTok{(ess, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess_sim  =} \KeywordTok{map_dbl}\NormalTok{(optimal,}
                           \OperatorTok{~}\KeywordTok{sim_n}\NormalTok{(.}\OperatorTok{$}\NormalTok{design, }\DecValTok{1}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{n ),}
        \DataTypeTok{ess0     =} \KeywordTok{map_dbl}\NormalTok{(optimal,}
                           \OperatorTok{~}\KeywordTok{evaluate}\NormalTok{(ess0, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess0_sim =} \KeywordTok{map_dbl}\NormalTok{(optimal,}
                           \OperatorTok{~}\KeywordTok{sim_n}\NormalTok{(.}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{n ) ) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{datadistnorm <-}\StringTok{ }\KeywordTok{Normal}\NormalTok{(}\DataTypeTok{two_armed=}\OtherTok{TRUE}\NormalTok{)}
\NormalTok{H_0norm <-}\StringTok{ }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{)}
\NormalTok{priornorm <-}\StringTok{ }\KeywordTok{PointMassPrior}\NormalTok{(}\FloatTok{1.0}\NormalTok{,}\DecValTok{1}\NormalTok{)}

\NormalTok{toernorm <-}\StringTok{ }\KeywordTok{Power}\NormalTok{(datadistnorm,H_0norm) }\OperatorTok{<=}\StringTok{ }\NormalTok{alpha}
\NormalTok{pownorm <-}\StringTok{ }\KeywordTok{Power}\NormalTok{(datadistnorm,priornorm) }\OperatorTok{>=}\StringTok{ }\NormalTok{min_power}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{essnorm <-}\StringTok{ }\KeywordTok{ExpectedSampleSize}\NormalTok{(datadistnorm,priornorm)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl_designsnorm <-}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}
    \DataTypeTok{type    =} \KeywordTok{c}\NormalTok{(}\StringTok{"one-stage"}\NormalTok{, }\StringTok{"group-sequential"}\NormalTok{, }\StringTok{"two-stage"}\NormalTok{),}
    \DataTypeTok{initial =} \KeywordTok{list}\NormalTok{(}
        \KeywordTok{OneStageDesign}\NormalTok{(}\DecValTok{20}\NormalTok{, }\FloatTok{2.0}\NormalTok{),}
        \KeywordTok{rpact_design}\NormalTok{(datadist, }\FloatTok{1.0}\NormalTok{, }\FloatTok{0.025}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\OtherTok{TRUE}\NormalTok{, order),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl_designsnorm <-}\StringTok{ }\NormalTok{tbl_designsnorm }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
       \DataTypeTok{optimal =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(initial, }\OperatorTok{~}\KeywordTok{minimize}\NormalTok{(}
\NormalTok{          ess,}
          \KeywordTok{subject_to}\NormalTok{(}
...
In all of the three designs, we should see that the expected sample size under the normal distributed test statistics is lower than the expected sample size when we use the \(t\)-distribution.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{essstudent <-}\StringTok{ }\KeywordTok{map_dbl}\NormalTok{(tbl_designs}\OperatorTok{$}\NormalTok{optimal,}\OperatorTok{~}\KeywordTok{evaluate}\NormalTok{(ess,.}\OperatorTok{$}\NormalTok{design))}
\NormalTok{essnorm <-}\StringTok{ }\KeywordTok{map_dbl}\NormalTok{(tbl_designsnorm}\OperatorTok{$}\NormalTok{optimal,}\OperatorTok{~}\KeywordTok{evaluate}\NormalTok{(ess,.}\OperatorTok{$}\NormalTok{design))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Student 
##  22 17.34883 16.97221
\end{verbatim}

\begin{verbatim}
## Normal 
##  21 15.87606 15.59285
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{diff <-}\StringTok{ }\NormalTok{essstudent}\OperatorTok{-}\NormalTok{essnorm}
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(diff}\OperatorTok{>}\DecValTok{0}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\hypertarget{scenario-ix-using-further-constraints}{%
\chapter{Scenario IX: Using further constraints}\label{scenario-ix-using-further-constraints}}

\hypertarget{general-assumptions}{%
\section{General assumptions}\label{general-assumptions}}
...
\NormalTok{datadist <-}\StringTok{ }\KeywordTok{Normal}\NormalTok{(}\DataTypeTok{two_armed=}\OtherTok{TRUE}\NormalTok{)}
\NormalTok{H_}\DecValTok{0}\NormalTok{ <-}\StringTok{ }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{)}
\NormalTok{prior <-}\StringTok{ }\KeywordTok{PointMassPrior}\NormalTok{(}\FloatTok{0.5}\NormalTok{,}\DecValTok{1}\NormalTok{)}
...
\hypertarget{constraint-ix-1-maximal-sample-size}{%
\section{Constraint IX-1: Maximal Sample Size}\label{constraint-ix-1-maximal-sample-size}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{init_onestage <-}\StringTok{ }\KeywordTok{OneStageDesign}\NormalTok{(}\DecValTok{100}\NormalTok{,}\DecValTok{2}\NormalTok{)}
\NormalTok{opt_onestage <-}\StringTok{ }\KeywordTok{minimize}\NormalTok{(ess,}\KeywordTok{subject_to}\NormalTok{(toer_cnstr,pow_cnstr),}\DataTypeTok{initial_design =}\NormalTok{ init_onestage)}
\KeywordTok{print}\NormalTok{(}\KeywordTok{evaluate}\NormalTok{(ess,opt_onestage}\OperatorTok{$}\NormalTok{design))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{smplsize_cnstr <-}\StringTok{ }\KeywordTok{MaximumSampleSize}\NormalTok{()}\OperatorTok{<=}\DecValTok{118}
\end{Highlighting}
\end{Shaded}

\hypertarget{initial-designs-4}{%
\subsection{Initial Designs}\label{initial-designs-4}}

As an initial design, we choose the \texttt{adoptr}-function \texttt{get\_initial\_design()}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{init_twostage <-}\StringTok{ }\KeywordTok{get_initial_design}\NormalTok{(}\FloatTok{0.5}\NormalTok{,alpha,}\DecValTok{1}\OperatorTok{-}\NormalTok{min_power,}\DataTypeTok{type=}\KeywordTok{c}\NormalTok{(}\StringTok{"two-stage"}\NormalTok{),}\DataTypeTok{dist=}\NormalTok{datadist)}
\end{Highlighting}
\end{Shaded}

\hypertarget{optimization-20}{%
\subsection{Optimization}\label{optimization-20}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{opt_twostage_cnstr <-}\StringTok{ }\KeywordTok{minimize}\NormalTok{(ess,}\KeywordTok{subject_to}\NormalTok{(toer_cnstr,pow_cnstr,smplsize_cnstr),}\DataTypeTok{initial_design =}\NormalTok{ init_twostage)}
\end{Highlighting}
\end{Shaded}

\hypertarget{testcases}{%
\subsection{Testcases}\label{testcases}}

At first, we verify the type one error rate and power constraints by simulation:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{toer <-}\StringTok{ }\KeywordTok{sim_pr_reject}\NormalTok{(opt_twostage_cnstr}\OperatorTok{$}\NormalTok{design,}\FloatTok{0.0}\NormalTok{,datadist)}
\NormalTok{power <-}\StringTok{ }\KeywordTok{sim_pr_reject}\NormalTok{(opt_twostage_cnstr}\OperatorTok{$}\NormalTok{design,}\FloatTok{0.5}\NormalTok{,datadist)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(toer}\OperatorTok{$}\NormalTok{prob}\OperatorTok{<=}\NormalTok{alpha}\OperatorTok{*}\NormalTok{(}\DecValTok{1}\OperatorTok{+}\NormalTok{tol))}
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(power}\OperatorTok{$}\NormalTok{prob}\OperatorTok{>=}\NormalTok{min_power}\OperatorTok{*}\NormalTok{(}\DecValTok{1}\OperatorTok{-}\NormalTok{tol))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{MaximumSampleSize}\NormalTok{(),opt_twostage_cnstr}\OperatorTok{$}\NormalTok{design)}\OperatorTok{<=}\DecValTok{118}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{opt_twostage <-}\StringTok{ }\KeywordTok{minimize}\NormalTok{(ess,}\KeywordTok{subject_to}\NormalTok{(toer_cnstr,pow_cnstr),}\DataTypeTok{initial_design =}\NormalTok{ init_twostage)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{evaluate}\NormalTok{(ess,opt_twostage_cnstr}\OperatorTok{$}\NormalTok{design)}\OperatorTok{>=}\StringTok{ }\KeywordTok{evaluate}\NormalTok{(ess,opt_twostage}\OperatorTok{$}\NormalTok{design))}
\end{Highlighting}
\end{Shaded}
